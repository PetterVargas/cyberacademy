    ...
    return [
      {
        ...
        href: `https://chatgpt.com/?utm_source=cyberacademy.divisioncero.com&${new URLSearchParams({
          hints: 'search',
          q,
        })}`,
        icon: (
      ...
      },
      {
        ...
        href: `https://claude.ai/new?utm_source=cyberacademy.divisioncero.com&${new URLSearchParams({
          q,
        })}`,
        icon: (
          <svg
