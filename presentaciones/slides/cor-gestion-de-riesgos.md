...
htmlAttrs:
  ...
  dir: ltr
seoMeta:
  ogTitle: Curso de Gestión de Riesgos
  ogDescription: Análisis y tratamiento del riesgo
  ogImage: https://cover.sli.dev
  twitterCard: summary_large_image
  twitterTitle: Curso de Gestión de Riesgos
  twitterDescription: Análisis y tratamiento del riesgo
  twitterImage: https://cover.sli.dev
download: true
exportFilename: cor-gestion-de-riesgos-cyberacademy-divisioncero
...
# Curso de Gestión de Riesgos {.font-extrabold .tracking-tight}
...
<!--
Bienvenida al curso de gestión de riesgos. Contenido de referencia (dummy) construido sobre la estructura estándar de CyberAcademy.
-->
...
- Aplicar los fundamentos de fundamentos de la gestión de riesgos en el día a día.
...
<!--
Continuamos con el módulo 1, fundamentos de la gestión de riesgos.
-->
...
Conceptos y controles clave relacionados con **fundamentos de la gestión de riesgos**.

<v-clicks>

- Conceptos clave de fundamentos de la gestión de riesgos.
...
<!--
Contenido de referencia (dummy) para fundamentos de la gestión de riesgos — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 2, identificación y evaluación de riesgos.
-->
...
Conceptos y controles clave relacionados con **identificación y evaluación de riesgos**.

<v-clicks>

- Conceptos clave de identificación y evaluación de riesgos.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para identificación y evaluación de riesgos — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 3, tratamiento del riesgo.
-->
...
Conceptos y controles clave relacionados con **tratamiento del riesgo**.

<v-clicks>

- Conceptos clave de tratamiento del riesgo.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para tratamiento del riesgo — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 4, gestión del riesgo de terceros.
-->
...
Conceptos y controles clave relacionados con **gestión del riesgo de terceros**.

<v-clicks>

- Conceptos clave de gestión del riesgo de terceros.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para gestión del riesgo de terceros — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 5, gobierno del riesgo.
-->
...
Conceptos y controles clave relacionados con **gobierno del riesgo**.

<v-clicks>

- Conceptos clave de gobierno del riesgo.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para gobierno del riesgo — desarrollar con el material real del curso.
-->
