...
info: |
  ## Curso de Ciberseguridad para Niños, Niñas y Adolescentes
...
htmlAttrs:
  ...
  dir: ltr
seoMeta:
  ogTitle: Curso de Ciberseguridad para Niños, Niñas y Adolescentes
  ogDescription: Ciberseguridad para niños y adolescentes
  ogImage: https://cover.sli.dev
  twitterCard: summary_large_image
  twitterTitle: Curso de Ciberseguridad para Niños, Niñas y Adolescentes
  twitterDescription: Ciberseguridad para niños y adolescentes
  twitterImage: https://cover.sli.dev
download: true
exportFilename: curso-de-ciberseguridad-para-ninos-ninas-y-adolescentes-cyberacademy-divisioncero
...
# Curso de Ciberseguridad para Niños, Niñas y Adolescentes {.font-extrabold .tracking-tight}
...
<!--
Bienvenida al curso de ciberseguridad para niños, niñas y adolescentes. Contenido de referencia (dummy) construido sobre la estructura estándar de CyberAcademy.
-->
...
- Aplicar los fundamentos de mi vida en internet en el día a día.
...
<!--
Continuamos con el módulo 1, mi vida en internet.
-->
...
Conceptos y controles clave relacionados con **mi vida en internet**.

<v-clicks>

- Conceptos clave de mi vida en internet.
...
<!--
Contenido de referencia (dummy) para mi vida en internet — desarrollar con el material real del curso.
-->
...
## Cuidando mi Información

<!--
Continuamos con el módulo 2, cuidando mi información.
-->
...
Conceptos y controles clave relacionados con **cuidando mi información**.

<v-clicks>

- Conceptos clave de cuidando mi información.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para cuidando mi información — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 3, reconociendo el peligro.
-->
...
Conceptos y controles clave relacionados con **reconociendo el peligro**.

<v-clicks>

- Conceptos clave de reconociendo el peligro.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para reconociendo el peligro — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 4, actuando con seguridad.
-->
...
Conceptos y controles clave relacionados con **actuando con seguridad**.

<v-clicks>

- Conceptos clave de actuando con seguridad.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para actuando con seguridad — desarrollar con el material real del curso.
-->
...
<!--
Continuamos con el módulo 5, buenos hábitos digitales.
-->
...
Conceptos y controles clave relacionados con **buenos hábitos digitales**.

<v-clicks>

- Conceptos clave de buenos hábitos digitales.
- Buenas prácticas recomendadas.
- Errores comunes a evitar.
...
<!--
Contenido de referencia (dummy) para buenos hábitos digitales — desarrollar con el material real del curso.
-->
